...
class NSWOpalAll(Resource):
    ...
    def get(self):
        db = get_db()
        details_cur = db.execute('select TRAIN_LINE, CARD_TYPE, PERIOD, COUNT from NSW_OPAL_CARD_TYPE_JULY_2016_APRIL_2019')
...
@api.route('/all/<string:CARD_TYPE>', methods=['GET'])
